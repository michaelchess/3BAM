...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['mutation'].columns['var_ID'].drop()
    post_meta.tables['mutation'].columns['variant_ID'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['mutation'].columns['var_ID'].create()
    post_meta.tables['mutation'].columns['variant_ID'].drop()
